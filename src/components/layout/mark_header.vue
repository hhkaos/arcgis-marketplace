    ...
    <div class="grid-container">
      <div class="column-24">
        ...
        <div class="tablet-hide">
          <!-- logo / home -->
          <a href="#" class="top-nav-title">ArcGIS Configurable Web Apps
            <!-- <br>
            <small style="font-style: italic;">Extend your organization with new templates, storymaps and much more.</small> -->
          </a>
          <!-- primary navigation sections -->
          <nav class="top-nav-list" role="navigation" aria-labelledby="topnav">
            <a class="top-nav-link" href="#">Templates</a>
            <a class="top-nav-link" href="#">My Apps</a>
          ...
          <nav class="class-top-nav-list right" role="navigation" aria-labelledby="usernav">
            ...
            <div v-show="isAuth" class="dropdown js-dropdown right">
              ...
              <nav class="dropdown-menu dropdown-right" role="menu">
                ...
                <a href="#" @click="logout()" class="dropdown-link" role="menu-item">Sign Out</a>
              </nav>
            </div>
          </nav>
        </div>
        ...
        <div class="tablet-show top-nav-flex">
          ...
          <header class="top-nav-flex-title">
            <a href="/" class="top-nav-link"><span class="phone-hide">ArcGIS </span>Configurable Web<span class="phone-hide"> Apps</span></a>
          </header>
          ...
          <nav class="top-nav-flex-list text-right" role="navigation" aria-labelledby="usernav">
            ...
            <a v-show="!isAuth" class="top-nav-link icon-ui-user margin-left-1 js-drawer-toggle" href="#" aria-label="Sign In"><span class="phone-hide">Sign In</span></a>
...
export default {
  ...
  methods: {
    ...
    logout: function () {
      var self = this
      this.$http.get('https://arcgis.domake.io/logout').then(function (response) {
        if (response.ok) {
          self.refreshAuth()
